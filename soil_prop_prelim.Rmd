...
O_plot.FUN <- function(data, title, xlab, ylab){
...
O_plot.FUN(OA.graphpairs.df, "O horizon depth vs. A horizon depth by Site", "O horizon depth (cm)", "A horizon depth (cm)") #run the function
?geom_point
